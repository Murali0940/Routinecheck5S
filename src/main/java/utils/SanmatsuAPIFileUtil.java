...
public class SanmatsuAPIFileUtil {
    ...
    /*
     * API modifieddate is treated as UTC.
     */
    ...
    /**
     * Counts today's Sanmatsu files.
     *
     * A record is considered a valid file when:
     *
     * 1. guid is available
     * 2. filetype = 1
     * 3. modifieddate is available
     * 4. modifieddate is treated as UTC
     * 5. UTC time is converted to India time (+05:30)
     * 6. Converted India date is today's date
     *
     * Icon classification:
     *
     * attribute = 1 -> Yellow Icon
     * attribute != 1 -> Non Yellow Icon
     *
     * @param jsonResponse Sanmatsu API response
    ...
    public FileCountResult getTodayFileCount(
        ...
        try {
            ...
            throw new RuntimeException(
                    "[SANMATSU] Failed to process today's "
                            + "file information",
                    e);
        }
    }
